...
y <- matrix(c(151.437,166.972,146.797,129.688,135.888,136.747,144.829, 150.621, 144.042, 146.693, 155.391,
...
147.549, 149.142, 156.848, 157.911, 153.578, 147.887, 148.445, 151.36), ncol=10,nrow=10)
print(y)

#print(y[1][7])
#for (rows in 1:nrow(y)) {
#  for (columns in 1:ncol(y)) {
